...
import { faLocation, faSearch, faList, faClose, faAngleDown, faAngleUp } from '@fortawesome/free-solid-svg-icons';
...
@Component({
  ...
  standalone: true,
  imports: [FontAwesomeModule, SidebarListComponent, ReactiveFormsModule, CriteriaFilterPipe],
